...
@Named
public class IDaoLacamentoImpl implements IDaoLancamento, Serializable {
	...
	@Override
	public List<Lancamento> consultarLimit10(Long codUser) {/*Método que vai listar limitando em 10*/
		List<Lancamento> lista = null;
		
		EntityTransaction transaction = entityManager.getTransaction();/*Vai iniciar uma transação com o banco de dados, para fazer transação de, salvar, deletar etc...*/
	...
	@Override
	public List<Lancamento> relatorioLacamento(String numNota, Date dataIni, Date dataFim) {
